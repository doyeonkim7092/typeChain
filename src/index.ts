...
const genesisBlock: Block = new Block(0, '12312323213', '', 'hello', 123456);
...
const getHshForBlock = (aBlock:Block):string =>
...
const isBlockValid = (candidateBlock: Block, previousBlock: Block) : boolean => {
    if(!Block.validateStructure(candidateBlock)) {
        ...
        return false;
    } else if(getHshForBlock(candidateBlock) !== candidateBlock.hash){
        return false;
    } else {
        return true;
    }
